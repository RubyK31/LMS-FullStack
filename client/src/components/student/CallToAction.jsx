...
const CallToAction = () => {
  return (
    <div className="flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0">
      <h1 className="text-2xl ms:text-4xl text-gray-800 font-semibold">Learn anything, anytime, anywhere</h1>
      <p className="text-gray-500 sm:text-sm">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla facilisi.
        Integer sit amet velit nec werb ere sapien tincidunt venenatis.
      </p>
